...
export function Signup() {
    ...
    function mySubmit(e: React.FormEvent<HTMLFormElement>) {
        ...
        axios.post("http://localhost:5112/users/new-user", formInfo)
            .then(result => {
    ...
    return (
        <div className='DivAroundsignupForm'>
            <div className='formpageDiv'>
                <form onSubmit={(e) => { mySubmit(e) }} >
                    < div className="DivAroundFormElements" >
                        <h1 className="title1" >Welcome to worlds cuisine</h1>
                        <p className="title2">_________________________</p>
                        <p className="title3"> SIGN UP</p>
                        ...
                        <div className="divAroundButtons">
                            ...
                            <button className='CreateAccountButton' ><a href="/" >Cancel</a></button>
                ...
                {/* <div className='divAroundImg'>
                    <img className='img1' src="./images/1.png" alt="1" />
                    <img className='img2' src="./images/2.png" alt="2" />
                    <img className='img3' src="./images/3.png" alt="3" />
                    <img className='img4' src="./images/4.png" alt="4" />
                    <img className='img5' src="./images/5.png" alt="5" />
                    <img className='img6' src="./images/6.png" alt="6" />
